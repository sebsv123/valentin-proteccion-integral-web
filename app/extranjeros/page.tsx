    ...
    <>
      ...
      <main className="overflow-x-clip">
        ...
        <AnswerFirstSection
          ...
          facts={en ? ['Students and Residents are distinct ASISA products for different situations.', 'The administration or consulate makes the final decision on the procedure.', 'The insurer and policy determine the certificate and contractual conditions.'] : ['Students y Residents son productos ASISA distintos para situaciones diferentes.', 'La administración o el consulado toman la decisión final del trámite.', 'La aseguradora y la póliza determinan el certificado y las condiciones contractuales.']}
          links={en ? [
