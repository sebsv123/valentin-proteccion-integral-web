...
export const foreignersContent = {
  es: {
    ...
    faq: [
      ...
      { q: '¿Puedo iniciar la contratación con mi pasaporte antes de tener NIE o TIE?', a: 'Algunas modalidades pueden tramitarse con pasaporte antes de disponer de NIE o TIE, según el producto y los requisitos de la aseguradora. Lo confirmamos antes de contratar.' },
      ...
      { q: '¿La póliza tiene copagos o periodos de carencia?', a: 'Depende del producto. Students y Residents figuran sin copagos ni carencias en el manual ASISA 2026. Confirmamos la modalidad y las condiciones que constan en la póliza o certificado.' },
  ...
  en: {
    ...
    faq: [
      { q: 'Which plan may fit a study or residence process in Spain?', a: 'It depends on the process and product. ASISA Health Students and ASISA Health Residents are described for different immigration situations and without co-payments or waiting periods. The administration or consulate makes the final decision, and the policy or certificate sets the applicable conditions.' },
      { q: 'Can I start arranging cover with my passport before I have an NIE or TIE?', a: 'Some plans may be arranged using a passport before you have an NIE or TIE, depending on the product and insurer requirements. We confirm this before proceeding.' },
      ...
      { q: 'Does the policy have co-payments or waiting periods?', a: 'It depends on the product. Students and Residents are described without co-payments or waiting periods in the ASISA 2026 manual. We confirm the product and the conditions shown in the policy or certificate.' },
