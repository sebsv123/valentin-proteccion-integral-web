...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/extranjeros`, lastModified: foreignersHubLastModified, changeFrequency: 'weekly', priority: 0.85 },
    { url: `${base}/en/foreigners`, lastModified: foreignersHubLastModified, changeFrequency: 'weekly', priority: 0.85, alternates: { languages: { es: `${base}/extranjeros`, en: `${base}/en/foreigners`, 'x-default': `${base}/extranjeros` } } },
    { url: `${base}/visados/seguro-medico`, lastModified: visaKnowledgeLastModified, changeFrequency: 'monthly', priority: 0.82, alternates: { languages: { es: `${base}/visados/seguro-medico`, en: `${base}/en/visa-health-insurance`, 'x-default': `${base}/visados/seguro-medico` } } },
    { url: `${base}/en/visa-health-insurance`, lastModified: visaKnowledgeLastModified, changeFrequency: 'monthly', priority: 0.82, alternates: { languages: { es: `${base}/visados/seguro-medico`, en: `${base}/en/visa-health-insurance`, 'x-default': `${base}/visados/seguro-medico` } } },
    { url: `${base}/visados/seguro-medico/estudios`, lastModified: visaKnowledgeLastModified, changeFrequency: 'monthly', priority: 0.8, alternates: { languages: { es: `${base}/visados/seguro-medico/estudios`, en: `${base}/en/visa-health-insurance/student-visa`, 'x-default': `${base}/visados/seguro-medico/estudios` } } },
    { url: `${base}/en/visa-health-insurance/student-visa`, lastModified: visaKnowledgeLastModified, changeFrequency: 'monthly', priority: 0.8, alternates: { languages: { es: `${base}/visados/seguro-medico/estudios`, en: `${base}/en/visa-health-insurance/student-visa`, 'x-default': `${base}/visados/seguro-medico/estudios` } } },
    { url: `${base}/visados/seguro-medico/residencia-no-lucrativa`, lastModified: visaKnowledgeLastModified, changeFrequency: 'monthly', priority: 0.78, alternates: { languages: { es: `${base}/visados/seguro-medico/residencia-no-lucrativa`, en: `${base}/en/visa-health-insurance/non-lucrative-residence`, 'x-default': `${base}/visados/seguro-medico/residencia-no-lucrativa` } } },
    { url: `${base}/en/visa-health-insurance/non-lucrative-residence`, lastModified: visaKnowledgeLastModified, changeFrequency: 'monthly', priority: 0.78, alternates: { languages: { es: `${base}/visados/seguro-medico/residencia-no-lucrativa`, en: `${base}/en/visa-health-insurance/non-lucrative-residence`, 'x-default': `${base}/visados/seguro-medico/residencia-no-lucrativa` } } },
    { url: `${base}/visados/seguro-medico/teletrabajo-internacional`, lastModified: visaKnowledgeLastModified, changeFrequency: 'monthly', priority: 0.75, alternates: { languages: { es: `${base}/visados/seguro-medico/teletrabajo-internacional`, en: `${base}/en/visa-health-insurance/digital-nomad`, 'x-default': `${base}/visados/seguro-medico/teletrabajo-internacional` } } },
    { url: `${base}/en/visa-health-insurance/digital-nomad`, lastModified: visaKnowledgeLastModified, changeFrequency: 'monthly', priority: 0.75, alternates: { languages: { es: `${base}/visados/seguro-medico/teletrabajo-internacional`, en: `${base}/en/visa-health-insurance/digital-nomad`, 'x-default': `${base}/visados/seguro-medico/teletrabajo-internacional` } } },
    { url: `${base}/visados/seguro-medico/requisitos-consulares`, lastModified: visaKnowledgeLastModified, changeFrequency: 'monthly', priority: 0.7, alternates: { languages: { es: `${base}/visados/seguro-medico/requisitos-consulares`, en: `${base}/en/visa-health-insurance/consulate-requirements`, 'x-default': `${base}/visados/seguro-medico/requisitos-consulares` } } },
    { url: `${base}/en/visa-health-insurance/consulate-requirements`, lastModified: visaKnowledgeLastModified, changeFrequency: 'monthly', priority: 0.7, alternates: { languages: { es: `${base}/visados/seguro-medico/requisitos-consulares`, en: `${base}/en/visa-health-insurance/consulate-requirements`, 'x-default': `${base}/visados/seguro-medico/requisitos-consulares` } } },
    ...
    { url: `${base}/en/insurance/accident-insurance`, lastModified: now, changeFrequency: 'weekly', priority: 0.85 },
    { url: `${base}/en/insurance/accident-insurance/business-self-employed`, lastModified: now, changeFrequency: 'weekly', priority: 0.8 },
    ...
    ...subpages.filter((subpage) => !((subpage.parent === 'accidentes' && subpage.slug === 'pyme-autonomos') || (subpage.parent === 'salud' && ['extranjeros', 'autonomos'].includes(subpage.slug)))).map((subpage) => {
