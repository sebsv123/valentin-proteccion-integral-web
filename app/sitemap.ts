...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/en/for/self-employed`, lastModified: now, changeFrequency: 'monthly', priority: 0.6, alternates: { languages: { es: `${base}/para/autonomos`, en: `${base}/en/for/self-employed`, 'x-default': `${base}/para/autonomos` } } },
