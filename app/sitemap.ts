...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/visados/seguro-medico`, lastModified: now, changeFrequency: 'monthly', priority: 0.82, alternates: { languages: { es: `${base}/visados/seguro-medico`, en: `${base}/en/visa-health-insurance`, 'x-default': `${base}/visados/seguro-medico` } } },
    { url: `${base}/en/visa-health-insurance`, lastModified: now, changeFrequency: 'monthly', priority: 0.82, alternates: { languages: { es: `${base}/visados/seguro-medico`, en: `${base}/en/visa-health-insurance`, 'x-default': `${base}/visados/seguro-medico` } } },
    { url: `${base}/visados/seguro-medico/estudios`, lastModified: now, changeFrequency: 'monthly', priority: 0.8, alternates: { languages: { es: `${base}/visados/seguro-medico/estudios`, en: `${base}/en/visa-health-insurance/student-visa`, 'x-default': `${base}/visados/seguro-medico/estudios` } } },
    { url: `${base}/en/visa-health-insurance/student-visa`, lastModified: now, changeFrequency: 'monthly', priority: 0.8, alternates: { languages: { es: `${base}/visados/seguro-medico/estudios`, en: `${base}/en/visa-health-insurance/student-visa`, 'x-default': `${base}/visados/seguro-medico/estudios` } } },
    { url: `${base}/visados/seguro-medico/residencia-no-lucrativa`, lastModified: now, changeFrequency: 'monthly', priority: 0.78, alternates: { languages: { es: `${base}/visados/seguro-medico/residencia-no-lucrativa`, en: `${base}/en/visa-health-insurance/non-lucrative-residence`, 'x-default': `${base}/visados/seguro-medico/residencia-no-lucrativa` } } },
    { url: `${base}/en/visa-health-insurance/non-lucrative-residence`, lastModified: now, changeFrequency: 'monthly', priority: 0.78, alternates: { languages: { es: `${base}/visados/seguro-medico/residencia-no-lucrativa`, en: `${base}/en/visa-health-insurance/non-lucrative-residence`, 'x-default': `${base}/visados/seguro-medico/residencia-no-lucrativa` } } },
    { url: `${base}/visados/seguro-medico/teletrabajo-internacional`, lastModified: now, changeFrequency: 'monthly', priority: 0.75, alternates: { languages: { es: `${base}/visados/seguro-medico/teletrabajo-internacional`, en: `${base}/en/visa-health-insurance/digital-nomad`, 'x-default': `${base}/visados/seguro-medico/teletrabajo-internacional` } } },
    { url: `${base}/en/visa-health-insurance/digital-nomad`, lastModified: now, changeFrequency: 'monthly', priority: 0.75, alternates: { languages: { es: `${base}/visados/seguro-medico/teletrabajo-internacional`, en: `${base}/en/visa-health-insurance/digital-nomad`, 'x-default': `${base}/visados/seguro-medico/teletrabajo-internacional` } } },
    { url: `${base}/visados/seguro-medico/requisitos-consulares`, lastModified: now, changeFrequency: 'monthly', priority: 0.7, alternates: { languages: { es: `${base}/visados/seguro-medico/requisitos-consulares`, en: `${base}/en/visa-health-insurance/consulate-requirements`, 'x-default': `${base}/visados/seguro-medico/requisitos-consulares` } } },
    { url: `${base}/en/visa-health-insurance/consulate-requirements`, lastModified: now, changeFrequency: 'monthly', priority: 0.7, alternates: { languages: { es: `${base}/visados/seguro-medico/requisitos-consulares`, en: `${base}/en/visa-health-insurance/consulate-requirements`, 'x-default': `${base}/visados/seguro-medico/requisitos-consulares` } } },
