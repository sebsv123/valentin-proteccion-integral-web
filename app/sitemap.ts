...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/en/insurance/accident-insurance`, lastModified: now, changeFrequency: 'weekly', priority: 0.85, alternates: { languages: { es: `${base}/seguros/accidentes`, en: `${base}/en/insurance/accident-insurance`, 'x-default': `${base}/seguros/accidentes` } } },
    { url: `${base}/en/insurance/accident-insurance/business-self-employed`, lastModified: now, changeFrequency: 'weekly', priority: 0.8, alternates: { languages: { es: `${base}/seguros/accidentes/pyme-autonomos`, en: `${base}/en/insurance/accident-insurance/business-self-employed`, 'x-default': `${base}/seguros/accidentes/pyme-autonomos` } } },
