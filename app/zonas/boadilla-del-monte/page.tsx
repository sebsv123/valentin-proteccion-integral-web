...
export const metadata: Metadata = {
  title: "Seguros en Boadilla del Monte — Asesor Local con Oficina | Valentín Protección Integral",
  description: "Mediador de seguros con oficina en Boadilla del Monte. Salud desde 22,50€/mes, vida, dental y mascotas. +10 años · +1.200 familias. Consulta gratis.",
  keywords: ["seguros Boadilla del Monte", "seguro salud Boadilla", "mediador seguros Boadilla del Monte", "seguro medico privado Boadilla"],
...
const serviceSchema = {
  ...
  "areaServed": ["Boadilla del Monte", "Majadahonda", "Pozuelo de Alarcón", "Madrid"],
};
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="text-[40px] sm:text-[48px] lg:text-[52px] font-bold text-black leading-[1.23] mb-4">
                  Seguros en Boadilla del Monte: Tu Mediador con Oficina Local
                </h1>
                <p className="text-xl text-[#4b4b4b] leading-relaxed mb-8 max-w-md">
                  Somos de Boadilla. Aquí vivimos, aquí trabajamos y aquí estamos cuando nos necesitas. Más de 1.200 familias en Madrid Oeste confían en nosotros.
                </p>
              ...
              <div className="relative">
                <div className="relative rounded-xl overflow-hidden shadow-[rgba(0,0,0,0.12)_0px_4px_16px_0px]">
                  <Image
                    src="/images/zonas/boadilla-del-monte.jpg"
        ...
        <section className="py-16 bg-black text-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 max-w-5xl">
            ...
            <h2 className="text-[36px] font-bold leading-[1.22] mb-12">
              Somos de Boadilla, no de paso
            </h2>
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { icon: Building2, title: "Oficina en Boadilla", desc: "C. de los Reyes Católicos, 1. Puedes venir cuando quieras. Sin cita previa." },
                { icon: Stethoscope, title: "Conocemos la red local", desc: "Sabemos qué clínicas y hospitales de la zona cubre cada póliza. Te orientamos sin rodeos." },
                { icon: Heart, title: "+10 años en la zona", desc: "Desde 2015 protegiendo familias de Boadilla. Nos conocen, nos recomiendan." },
              ].map((item, i) => (
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 max-w-5xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                { icon: Stethoscope, title: "Salud privada", desc: "Sin copagos. Red completa Madrid Oeste." },
                { icon: Home, title: "Vida + Hipoteca", desc: "Urbanizaciones residenciales de Boadilla." },
                { icon: Dog, title: "Mascotas", desc: "Parques y zonas verdes. Cobertura real." },
                { icon: Heart, title: "Dental", desc: "Sin listas de espera. Sin carencias." },
              ].map((item, i) => (
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="relative rounded-xl overflow-hidden shadow-[rgba(0,0,0,0.12)_0px_4px_16px_0px]">
                <Image
                  ...
                  alt="Rosa y Sebastián Valentín · Tu equipo local en Boadilla"
                  width={500}
                  height={500}
              ...
              <div>
                ...
                <p className="text-lg text-[#4b4b4b] mb-6">
                  Tu equipo local en Boadilla. Conozco cada rincón del municipio porque aquí vivimos y trabajamos. Somos los mediadores de referencia de más de 1.200 familias en Madrid Oeste.
                </p>
                <div className="space-y-3 mb-8">
                  <div className="flex items-center gap-3 text-[#4b4b4b]">
                    <MapPin className="w-5 h-5 text-black" />
                    <span>C. de los Reyes Católicos, 1, Boadilla del Monte</span>
                  </div>
                  <div className="flex items-center gap-3 text-[#4b4b4b]">
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 max-w-5xl">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { num: "1", title: "WhatsApp", desc: 'Escribe "Boadilla" y cuéntanos qué necesitas.' },
                { num: "2", title: "Te llamamos", desc: "En menos de 30 minutos, Rosa o Sebastián te llaman." },
                { num: "3", title: "Cita si quieres", desc: "Presencial en nuestra oficina o por teléfono. Tú decides." },
              ].map((step, i) => (
        ...
        <section className="py-16 bg-black text-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 max-w-5xl text-center">
            <h2 className="text-[36px] sm:text-[48px] font-bold leading-[1.22] mb-4">
              Protege lo que más te importa en Boadilla
            </h2>
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-8">
              {["Oficina en Boadilla", "Mediador independiente", "DGSFP C012479234434D"].map((item, i) => (
