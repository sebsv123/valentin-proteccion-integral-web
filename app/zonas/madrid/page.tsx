...
export const metadata: Metadata = {
  ...
  description: "Asesores de seguros en Madrid. Salud, vida, dental, mascotas y más. Asesoramiento cercano y con registro oficial en la DGSFP. Llámanos o escríbenos por WhatsApp.",
  keywords: ["seguros Madrid", "asesor seguros Madrid", "seguro salud Madrid", "agente seguros Madrid", "seguros Madrid centro"],
  alternates: { canonical: "https://valentinproteccionintegral.com/zonas/madrid" },
  openGraph: {
    title: "Seguros en Madrid — Asesoría Personal | Valentín Protección Integral",
    description: "Asesores de seguros en Madrid. Salud, vida, dental, mascotas y más. Asesoramiento cercano y con registro oficial en la DGSFP.",
