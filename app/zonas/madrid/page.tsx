...
export const metadata: Metadata = {
  title: "Seguros en Madrid — Asesoría Personal | Valentín Protección Integral",
  description: "Asesores de seguros en Madrid. Salud, vida, dental, mascotas y más. Sin copagos, sin permanencias. +10 años y +1.200 familias. Llámanos o escríbenos por WhatsApp.",
  keywords: ["seguros Madrid", "asesor seguros Madrid", "seguro salud Madrid", "mediador Madrid", "seguros Madrid centro"],
  alternates: { canonical: "https://valentinproteccionintegral.com/zonas/madrid" },
  openGraph: {
    title: "Seguros en Madrid — Asesoría Personal | Valentín Protección Integral",
    description: "Asesores de seguros en Madrid. Salud, vida, dental, mascotas y más. Sin copagos, sin permanencias. +10 años y +1.200 familias.",
...
export default function MadridPage() {
  ...
  const seguros = [
    ...
    { nombre: "Autónomos", desc: "Protección para ti y tu negocio en Madrid." },
  ];

  const reviews = [
    { nombre: "Elena S.", barrio: "Chamberí", texto: "Rosa nos ayudó a comparar seguros de salud para toda la familia. Explicó todo con claridad y sin presiones. Un servicio excelente." },
    { nombre: "Antonio M.", barrio: "La Latina", texto: "Contacté por WhatsApp un sábado por la tarde y me respondieron en 20 minutos. Profesionales y cercanos. Muy recomendables." },
    { nombre: "Marta y Diego", barrio: "Vallecas", texto: "Llevamos 3 años con Valentín Protección Integral. Cuando tuvimos un problema con el seguro de casa, Sebastián lo resolvió en 48 horas." },
  ];
      ...
      <main className="min-h-screen bg-white">
              ...
              <div className="relative">
                <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                  <Image
                    ...
                    alt="Rosa y Sebastián - Asesores de seguros en Madrid"
                    width={600}
                    height={500}
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                  Llevamos más de 10 años asesorando a familias en Madrid. 
        ...
        <section className="bg-slate-900 text-white py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 max-w-4xl text-center">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">¿Estás en Madrid?</h2>
