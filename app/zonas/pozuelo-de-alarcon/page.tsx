...
export const metadata: Metadata = {
  ...
  keywords: ["seguros Pozuelo de Alarcón", "asesor seguros Pozuelo", "seguro salud Pozuelo", "mediador Pozuelo de Alarcón"],
...
const serviceSchema = {
  ...
  "description": "Asesores de seguros independientes en Pozuelo de Alarcón. Salud, vida, dental, mascotas, decesos y seguros para autónomos.",
  "aggregateRating": {
