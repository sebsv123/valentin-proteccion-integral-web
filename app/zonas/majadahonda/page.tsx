...
export const metadata: Metadata = {
  ...
  keywords: ["seguros Majadahonda", "asesor seguros Majadahonda", "seguro salud Majadahonda", "mediador Majadahonda"],
...
const serviceSchema = {
  ...
  "description": "Asesores de seguros independientes en Majadahonda. Salud, vida, dental, mascotas, decesos y seguros para autónomos.",
  "aggregateRating": {
...
export default function MajadahondaPage() {
  ...
  const seguros = [
    ...
    { nombre: "Autónomos", desc: "Protección para ti y tu negocio en Majadahonda." },
  ];

  const reviews = [
    { nombre: "Lucía M.", barrio: "El Plantío", texto: "Rosa nos ayudó a elegir el seguro de salud para toda la familia. Explicó todo con paciencia y sin tecnicismos. Muy profesional." },
    { nombre: "Javier R.", barrio: "Majadahonda Centro", texto: "Contacté por WhatsApp y en 20 minutos tenía la comparativa. Al final ahorré 200€ al año en el seguro de casa." },
    { nombre: "Carmen y Luis", barrio: "Urbanización Las Vegas", texto: "Llevamos 4 años con Valentín Protección Integral. Cuando nos operaron del corazón, Sebastián gestionó todo con la aseguradora. Impecable." },
  ];
    ...
    <>
      ...
      <main className="min-h-screen bg-white">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                  Seguro de salud en Majadahonda
                </h1>
                <p className="text-xl text-slate-300 mb-4">
                  Asesoría personal y sin intermediarios
                </p>
                <p className="text-lg text-slate-400 mb-8 leading-relaxed">
                  Rosa y Sebastián son los asesores de seguros de referencia en Majadahonda. 
              ...
              <div className="relative">
                <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                  <Image
                    ...
                    alt="Rosa y Sebastián - Asesores de seguros en Majadahonda"
                    width={600}
                    height={500}
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 max-w-5xl">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <Image
                ...
                alt="Majadahonda - Asesores de seguros locales"
                width={1200}
                height={675}
                className="w-full h-auto object-cover"
                priority
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-6">
                <p className="text-white text-sm">📷 Majadahonda, Madrid · Tu asesor de seguros local</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 max-w-6xl">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 text-center mb-12">
              Seguros populares en Majadahonda
            </h2>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 max-w-6xl">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  src="/images/rosa_y_sebastian.jpeg"
                  alt="Rosa y Sebastián Valentín - Asesores de seguros en Majadahonda"
                  width={600}
                  height={500}
                  className="w-full h-auto object-cover"
                  priority
              ...
              <div>
                ...
                <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                  Llevamos más de 10 años asesorando a familias en Majadahonda. 
        ...
        <section className="py-20 bg-slate-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 max-w-6xl">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 text-center mb-12">
              Lo que dicen los vecinos de Majadahonda
            </h2>
        ...
        <section className="bg-slate-900 text-white py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 max-w-4xl text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">Habla con nosotros hoy. Comparativa gratis en 30 minutos.</p>
            <a 
              href={wCotiza}
