        ...
        <section className="py-16 bg-[#0F5E9C]">
          <div className="container mx-auto px-4 max-w-3xl text-center text-white">
            ...
            <p className="text-xl text-white/80 mb-8">
              En el 95% de los casos, mejoramos los presupuestos bancarios con coberturas superiores y primas más ajustadas. <strong>Independientes: trabajamos para ti, no para la compañía.</strong>
            </p>
