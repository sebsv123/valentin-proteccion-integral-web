...
export default async function EnglishHealthSelfEmployed({ params }: { params: Promise<{ locale: string }> }) { const { locale } = await params; if (locale !== 'en') notFound(); return <ProductSubpagePageView parent="salud" subpage={english} locale="en" />; }
