    ...
    <>
      ...
      <main className="min-h-screen bg-white pt-24 sm:pt-28">
        ...
        <AnswerFirstSection
          ...
          title={en ? 'Students and Residents serve different situations' : 'ASISA Health Students y ASISA Health Residents responden a situaciones distintas'}
          answer={en ? 'The 2026 ASISA product manual describes ASISA Health Students and ASISA Health Residents as no-copayment, no-waiting-period products for different immigration situations. The applicable product and policy set the contractual conditions.' : 'El manual de producto ASISA 2026 describe ASISA Health Students y ASISA Health Residents como productos sin copagos ni carencias para situaciones migratorias distintas. El producto aplicable y la póliza fijan las condiciones contractuales.'}
          facts={en ? ['Students: student visa, 2 months to 1 year, non-renewable initial product.', 'Residents: residence or long-stay visa, one year; renewal conditions apply.', 'Certificate, refund, travel assistance and repatriation depend on the named product and policy.'] : ['Students: visado de estudiante, de 2 meses a 1 año y producto inicial no renovable.', 'Residents: residencia o visado de larga estancia, un año y renovación condicionada.', 'El certificado, la devolución, la asistencia y la repatriación dependen del producto y de la póliza.']}
        />
