...
export const visaKnowledgePages: Record<VisaKnowledgePageKey, VisaKnowledgePage> = {
  ...
  nonLucrative: {
    ...
    documents: {
      es: ['Las páginas consulares suelen enumerar certificado o justificante del seguro; revisa original/copia, traducción y prueba de vigencia según tu oficina.', 'No se afirma que la legislación nacional exija aportar un documento concreto con un nombre universal; verifica la lista local vigente.'],
      en: ['Consular pages list an insurance certificate or other proof; check originals/copies, translation and proof of validity for your office.', 'The national rule does not establish one universally named document; verify the current local checklist.'],
    },
    consulates: {
  ...
  digitalNomad: {
    ...
    answer: {
      es: 'La vía de teletrabajo internacional no debe resumirse como “siempre hace falta un seguro privado”. La guía oficial de UGE contempla acreditar cobertura de Seguridad Social cuando una norma internacional aplicable la mantiene; si esa cobertura no existe, indica seguro público o privado con coberturas equiparables a las del Sistema Nacional de Salud. El visado consular y la autorización de residencia pueden tener listas/documentación distintas: comprueba qué vía solicitas.',
      en: 'The international telework route should not be reduced to “private insurance is always required”. UGE guidance allows evidence of Social Security coverage where an applicable international coordination rule maintains it; where that does not apply, it describes public or private insurance with cover comparable to Spain’s National Health System. A consular visa and a residence authorisation may have different document lists: check which route you are applying for.',
    },
    officialRequirement: {
      es: ['La Ley 14/2013 regula el visado y la residencia de teletrabajo internacional.', 'UGE publica la documentación orientativa, incluida la vía de cobertura de Seguridad Social o seguro público/privado cuando corresponda.', 'No se publica aquí una conclusión sobre la aplicabilidad de un convenio al caso personal: depende de país, empleo y régimen de cobertura.'],
      en: ['Law 14/2013 governs the international telework visa and residence route.', 'UGE publishes supporting-document guidance, including Social Security coverage or public/private insurance where applicable.', 'This page does not determine whether a coordination agreement applies to an individual case; that depends on country, employment and coverage status.'],
    },
    practical: {
