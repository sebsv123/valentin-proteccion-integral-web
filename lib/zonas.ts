...
export const zonas: Zona[] = [
  {
    ...
    provincia: 'Madrid',
    cp: '28660',
    metaTitle: 'Seguros en Boadilla del Monte – Salud, Vida y Mascotas | Valentín Protección Integral',
    ...
    faqsLocales: [
      ...
      },
      {
        ...
        a: 'El precio de un seguro de salud en Boadilla del Monte varía según la edad, las coberturas y la modalidad elegida. En nuestra consulta gratuita te asesoramos de forma independiente y buscamos la mejor solución para tu perfil concreto, comparando entre las principales compañías del mercado. Sin coste ni compromiso.',
      },
      {
  ...
  },
  {
    ...
    provincia: 'Madrid',
    cp: '28230',
    metaTitle: 'Seguros en Las Rozas de Madrid – Salud, Vida y Autónomos | Valentín Protección Integral',
  ...
  },
  {
    ...
    provincia: 'Madrid',
    cp: '28220',
    metaTitle: 'Seguros en Majadahonda – Salud, Vida y Autónomos | Valentín Protección Integral',
  ...
  },
  {
    ...
    provincia: 'Madrid',
    cp: '28223',
    metaTitle: 'Seguros en Pozuelo de Alarcón – Salud Premium, Vida y Jurídico | Valentín Protección Integral',
  ...
  },
  {
    ...
    provincia: 'Madrid',
    cp: '28001',
    metaTitle: 'Seguros en Madrid – Asesores Independientes con +10 Años | Valentín Protección Integral',
    ...
    faqsLocales: [
      ...
      },
      {
        ...
        a: 'Con un asesor independiente siempre accedes a las mismas coberturas y precios — o mejores — pero con alguien que compara el mercado completo por ti y defiende tus intereses si hay un siniestro. Un agente de una sola compañía solo puede ofrecerte su propio catálogo. Somos independientes: nuestra obligación legal es velar por ti.',
      },
      {
      ...
      },
      {
        ...
        a: 'Un agente trabaja para una o varias compañías aseguradoras y solo puede ofrecerte sus productos. Un corredor o mediador independiente, como Valentín Protección Integral, trabaja para el cliente: compara entre las principales compañías del mercado y recomienda la opción más adecuada para tu situación. La DGSFP regula ambas figuras.',
      },
      {
