...
export const blogPosts: BlogPost[] = [
  {
    ...
    category: 'consejos',
    readTime: '22 min',
    metaTitle: 'Mejor seguro médico calidad-precio España 2026 | Valentín',
  ...
  },
  {
    ...
    category: 'consejos',
    readTime: '21 min',
    metaTitle: '¿Son fiables las opiniones de seguros? 2026 | Valentín',
    ...
    sections: [
      {
        ...
        content: [
          ...
          'En nuestra experiencia como agentes registrados DGSFP en Boadilla, hemos detectado que las pólizas bancarias pueden llegar a costar entre un 30% y un 50% más que un seguro de vida de idénticas coberturas contratado externamente. Esto sucede porque el banco utiliza el seguro como un producto de margen adicional, aprovechando la posición de fuerza durante la firma de la hipoteca. En 2026, la legislación española es muy clara al respecto: el cliente tiene derecho a contratar el seguro de vida con la compañía que prefiera, siempre y cuando la póliza incluya una cláusula de beneficiario a favor del banco por el importe de la deuda pendiente.',
  ...
  },
  {
    ...
    category: 'consejos',
    readTime: '20 min',
    metaTitle: 'Seguro de decesos en Madrid: qué cubre y gestiona',
  ...
  },
  {
    ...
    category: 'consejos',
    readTime: '17 min',
    metaTitle: '¿Seguro dental o salud completa? Guía Madrid',
  ...
  },
  {
    ...
    image: '/images/blog/protector-solar-beneficios.jpg',
    imageAlt: 'Mujer joven aplicándose protector solar en la cara frente a un espejo, cuidado de la piel y fotoprotección diaria',
    date: '2026-06-03',
