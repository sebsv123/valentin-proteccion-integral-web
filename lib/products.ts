...
export const subpages: ProductSubpage[] = [
  ...
  { parent: 'salud', slug: 'reembolso', name: 'Salud con reembolso', label: 'REEMBOLSO', eyebrow: 'SALUD · LIBRE ELECCIÓN', title: 'Seguro de salud con reembolso: libertad fuera del cuadro médico', summary: 'Una modalidad de reembolso puede permitirte acudir a profesionales fuera del cuadro médico y solicitar el reintegro previsto, según porcentaje, límites, servicios, documentación y condiciones de la póliza.', heroImage: '/images/products/health-medical-care.webp', heroAlt: 'Paciente revisando opciones de atención médica', bullets: ['Puede permitir usar profesionales o centros fuera del cuadro médico, según el producto.', 'El porcentaje y los límites de reintegro deben comprobarse en la documentación.', 'La solicitud puede exigir factura, justificante y otros documentos según la aseguradora.'], faqs: [{ q: '¿Cómo funciona el reembolso?', a: 'Normalmente abonas la asistencia fuera de la red y solicitas el reintegro conforme al procedimiento, porcentaje, límites y plazos de la póliza.' }, { q: '¿Incluye también el cuadro médico?', a: 'Algunos productos combinan red concertada y reembolso. Comprueba el producto concreto y sus condiciones.' }], whatsappMessage: 'Hola, quiero información sobre la modalidad de REEMBOLSO.', metaTitle: 'Seguro de salud con reembolso en Madrid | VPI', metaDescription: 'Revisa cómo funciona una modalidad de reembolso: profesionales fuera del cuadro médico, porcentajes, límites y documentación según la póliza.', h1: 'Seguro de Salud con Reembolso en Madrid' },
