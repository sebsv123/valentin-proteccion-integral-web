...
export const subpages: ProductSubpage[] = [
  ...
  { parent: 'salud', slug: 'completa', name: 'Salud completa', label: 'COMPLETA', eyebrow: 'SALUD · COMPLETA', title: 'La modalidad con hospitalización y cirugía: qué conviene comprobar', summary: 'Una modalidad completa puede incluir hospitalización y cirugía junto con especialistas, urgencias y pruebas según el producto y la póliza. Conviene comprobar qué incluye realmente la opción que revisas.', heroImage: '/images/products/health-medical-care.webp', heroAlt: 'Atención médica integral y completa', bullets: ['Comprueba si la hospitalización y la cirugía forman parte de la modalidad y bajo qué condiciones.', 'Especialistas, urgencias y pruebas diagnósticas dependen del producto y su documentación.', 'Las pruebas avanzadas, la segunda opinión y otros servicios pueden variar según el plan.', 'La asistencia en viaje o el traslado sanitario solo aplican cuando aparecen en la póliza concreta.', 'La salud mental, la fisioterapia y otros complementos dependen de la modalidad contratada.'], faqs: [{ q: '¿Qué diferencia hay entre la modalidad básica y la completa?', a: 'La modalidad básica puede centrarse en consultas, especialistas y pruebas ambulatorias. Una modalidad completa puede añadir hospitalización y cirugía, pero las coberturas concretas dependen de la aseguradora y del plan.' }, { q: '¿Tiene periodo de carencia?', a: 'Las carencias dependen de la aseguradora, la modalidad y la prestación. Revisa las condiciones generales y particulares antes de contratar.' }, { q: '¿Puedo añadir dental o reembolso a la modalidad completa?', a: 'Algunas aseguradoras permiten complementos dentales o de reembolso, sujetos al producto y sus condiciones.' }], whatsappMessage: 'Hola, quiero orientación sobre la modalidad COMPLETA de SALUD.', metaTitle: 'Seguro de salud con hospitalización en Madrid | VPI', metaDescription: 'Revisa si una modalidad de salud incluye hospitalización, cirugía y pruebas junto con atención ambulatoria. VPI te ayuda a comparar condiciones.', h1: 'Seguro de Salud con Hospitalización en Madrid' },
