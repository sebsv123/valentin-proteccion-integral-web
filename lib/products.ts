...
export const subpages: ProductSubpage[] = [
  ...
  { parent: 'salud', slug: 'autonomos', name: 'Salud para autónomos', label: 'AUTÓNOMOS', eyebrow: 'SALUD · AUTÓNOMOS', title: 'Seguro de salud para autónomos en Madrid: cobertura y condiciones', summary: 'Para una persona autónoma conviene separar la decisión sobre la cobertura sanitaria del tratamiento fiscal. Revisa médicos, especialistas, pruebas, hospitalización y copagos según el plan; el tratamiento de la prima como gasto deducible depende de la estimación directa, la normativa vigente y tus circunstancias.', heroImage: '/images/products/health-medical-care.webp', heroAlt: 'Autónomo trabajando con tranquilidad', bullets: ['La cobertura sanitaria depende de la modalidad y la póliza.', 'Compara medicina general, especialistas, pruebas, urgencias y hospitalización según el plan.', 'En estimación directa, la regla puede contemplar un gasto deducible para primas de enfermedad con un límite de 500 € por persona y 1.500 € por cada persona con discapacidad, sujeto a requisitos.', 'VPI puede ayudarte a revisar la documentación del seguro; no presta asesoramiento fiscal individual.', 'Dental, asistencia en viaje u otros complementos solo aplican si aparecen en el producto.'], faqs: [{ q: '¿Puedo considerar la prima como gasto deducible?', a: 'El artículo 30.2.5ª.a) de la Ley del IRPF contempla las primas de enfermedad en estimación directa para la propia cobertura, la del cónyuge y la de hijos menores de veinticinco años que convivan con el contribuyente, con los límites y requisitos aplicables. Consulta la AEAT o a un asesor fiscal.' }, { q: '¿Los 500 € significan que Hacienda me devuelve 500 €?', a: 'No. Los 500 € son un límite de gasto deducible dentro de la regla aplicable, no una devolución automática ni una reducción euro por euro del impuesto a pagar. El efecto depende de tu situación fiscal.' }, { q: '¿Puedo incluir a mi familia?', a: 'La regla citada menciona la propia cobertura, la del cónyuge y la de hijos menores de veinticinco años que convivan con el contribuyente, sujeto a los requisitos y límites vigentes. No equivale a incluir automáticamente a cualquier familiar.' }, { q: '¿Qué cobertura incluye un seguro para autónomos?', a: 'Puede incluir medicina general, especialistas, urgencias, pruebas, hospitalización u otras prestaciones según la modalidad y la póliza. No existe un paquete sanitario universal por ser autónomo.' }, { q: '¿Qué pasa si tengo una sociedad?', a: 'La cobertura y cualquier tratamiento fiscal pueden depender de cómo se contrate la póliza, quién pague la prima y la estructura aplicable. Compruébalo con la AEAT o con un asesor fiscal.' }], whatsappMessage: 'Hola, soy autónomo y quiero revisar mi seguro de salud y el tratamiento de la prima.', metaTitle: 'Seguro de salud para autónomos: cobertura y condiciones | VPI', metaDescription: 'Revisa la cobertura sanitaria para autónomos y separa las condiciones del seguro de cualquier tratamiento fiscal, que depende de la normativa y tu situación.', h1: 'Seguro de Salud para Autónomos en Madrid' },
...
export const testimonials = [
  ...
  { name: 'Jordi Mena', location: 'Sevilla', quote: 'Excelente servicio y respuesta inmediata. Me ayudó a decidir sin volver todo más complicado de lo necesario.', avatar: 'J' },
