...
export const products: Product[] = [
  {
    ...
    metaDescription: '¿Sanitas, Adeslas o Asisa? Te ayudamos a elegir el seguro de salud que mejor se adapta a ti y tu familia. Sin letra pequeña. Consulta gratis hoy.',
    h1: 'Seguro de Salud en Madrid',
  },
  {
    slug: 'vida',
    name: 'Seguro de vida',
    ...
    metaTitle: 'Seguro de Vida en Madrid · Protege a Tu Familia | Valentín',
    metaDescription: 'Un seguro de vida bien elegido puede cambiarlo todo para tu familia. Te explicamos qué cubre, cuánto cuesta y cómo contratarlo sin sorpresas.',
    h1: 'Seguro de Vida en Madrid',
    customAdvisor: {
      name: 'Sebastián',
  ...
  },
  {
    ...
    metaTitle: 'Seguro para Mascotas Madrid · Protege a Tu Animal | Valentín',
    metaDescription: 'Desde 8€/mes tu mascota puede estar cubierta ante accidentes, enfermedades y responsabilidad civil. Comparamos las mejores opciones del mercado.',
    h1: 'Seguro para Mascotas en Madrid',
  },
  {
    slug: 'dental',
    name: 'Seguro dental',
    ...
    metaTitle: 'Seguro Dental en Madrid · Ahorra en Tu Sonrisa | Valentín',
    metaDescription: '¿Pagas demasiado por el dentista? Un buen seguro dental puede ahorrarte cientos de euros al año. Te encontramos el mejor para ti o tu familia.',
    h1: 'Seguro Dental en Madrid',
  },
  {
    slug: 'accidentes',
    ...
    metaTitle: 'Seguro de Accidentes Madrid · Cobertura Real | Valentín',
    metaDescription: '¿Sabes qué pasaría si mañana tuvieras un accidente y no pudieras trabajar? Un seguro de accidentes es más asequible de lo que crees. Infórmate ya.',
    h1: 'Seguro de Accidentes en Madrid',
  },
  {
    ...
    metaTitle: 'Seguro para Electrodomésticos · Sin Sorpresas | Valentín',
    metaDescription: 'Lavadora rota, nevera averiada... ¿Y ahora qué? Te ayudamos a proteger tus electrodomésticos con la cobertura justa al mejor precio. Consulta ya.',
    h1: 'Seguro para Electrodomésticos',
  },
  {
    ...
    metaDescription: 'Un abogado cuando lo necesitas, sin coste extra. El seguro de protección jurídica te defiende en conflictos laborales, de tráfico, consumo y más.',
    h1: 'Seguro de Protección Jurídica',
  },
  {
    slug: 'negocio',
    ...
    metaTitle: 'Seguro para tu Negocio en Madrid · Pymes | Valentín',
    metaDescription: 'Protege tu empresa, local o negocio con el seguro adecuado. Asesoramos a autónomos y pymes en Madrid para que ningún imprevisto te deje sin operar.',
    h1: 'Seguro para tu Negocio o Pyme',
  },
  {
    slug: 'decesos',
    ...
    metaTitle: 'Seguro de Decesos Madrid · Sin Tabúes | Valentín',
    metaDescription: 'Hablar de decesos es difícil, pero tenerlo previsto es un regalo para tu familia. Te explicamos todo con calma y encontramos la opción más justa.',
    h1: 'Seguro de Decesos en Madrid',
  },
  {
    slug: 'viaje',
