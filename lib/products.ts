...
export const subpages: ProductSubpage[] = [
  ...
  { parent: 'salud', slug: 'autonomos', name: 'Salud para autónomos', label: 'AUTÓNOMOS', eyebrow: 'SALUD · AUTÓNOMOS', title: 'Seguro de salud para autónomos en Madrid: cobertura y condiciones', summary: 'Para una persona autónoma conviene separar la decisión de cobertura sanitaria del tratamiento fiscal: revisa médicos, especialistas, pruebas, hospitalización y copagos según el plan; cualquier deducción depende de la normativa y circunstancias aplicables.', heroImage: '/images/products/health-medical-care.webp', heroAlt: 'Autónomo trabajando con tranquilidad', bullets: ['La cobertura sanitaria depende de la modalidad y la póliza.', 'Compara medicina general, especialistas, pruebas, urgencias y hospitalización según el plan.', 'El tratamiento fiscal de las primas puede estar sujeto a requisitos y límites de la normativa vigente.', 'VPI puede ayudarte a revisar la documentación del seguro; no presta asesoramiento fiscal individual.', 'Dental, asistencia en viaje u otros complementos solo aplican si aparecen en el producto.'], faqs: [{ q: '¿Puedo aplicar algún tratamiento fiscal a la prima?', a: 'La normativa puede contemplar límites para primas de seguro de enfermedad, pero la aplicación depende de tu situación fiscal, modalidad de tributación y requisitos vigentes. Consulta la AEAT o a un asesor fiscal.' }, { q: '¿Qué cobertura incluye el seguro para autónomos?', a: 'Puede incluir medicina general, especialistas, urgencias, pruebas, hospitalización u otras prestaciones según la modalidad y la póliza.' }, { q: '¿Necesito tener una sociedad?', a: 'La cobertura y cualquier tratamiento fiscal dependen de cómo se contrate la póliza y de la normativa aplicable; no es una ventaja automática del seguro.' }], whatsappMessage: 'Hola, soy autónomo y quiero información sobre seguro de salud y sus condiciones.', metaTitle: 'Seguro de salud para autónomos en Madrid | VPI', metaDescription: 'Revisa la cobertura sanitaria para autónomos y separa las condiciones del seguro de cualquier tratamiento fiscal, que depende de la normativa y tu situación.', h1: 'Seguro de Salud para Autónomos en Madrid' },
