...
export const subpages: ProductSubpage[] = [
  ...
  { parent: 'salud', slug: 'familias', name: 'Salud para familias', label: 'FAMILIAS', eyebrow: 'SALUD · FAMILIAS', title: 'SALUD para familias con una orientación más útil y menos fría', summary: 'Para una familia conviene revisar el uso previsto —por ejemplo, pediatría, consultas repetidas y urgencias— junto con copagos, hospitalización y condiciones de la modalidad.', heroImage: '/images/premium/hero-family.webp', heroAlt: 'Familia caminando junta', bullets: ['Compara copago y sin copago según la frecuencia de uso que esperas.', 'Revisa cómo se atienden pediatría y otras necesidades familiares en la modalidad concreta.', 'Hospitalización, urgencias y otras coberturas dependen del producto y la póliza.'], faqs: [{ q: '¿Compensa una modalidad con copago para una familia?', a: 'Depende del uso previsto y del equilibrio que busquéis entre prima y utilización. Revisad los copagos de cada servicio y las condiciones de la modalidad.' }, { q: '¿Conviene mirar solo el precio?', a: 'No. En una familia conviene revisar pediatría, urgencias, hospitalización, red médica y condiciones de uso además de la prima.' }], whatsappMessage: 'Hola, quiero orientación sobre SALUD para FAMILIAS.', metaTitle: 'Seguro de salud para familias en Madrid: copagos y uso | VPI', metaDescription: 'Orientación para revisar copagos, pediatría, hospitalización y uso familiar según las condiciones del seguro.', h1: 'Seguro de Salud para Familias en Madrid' },
