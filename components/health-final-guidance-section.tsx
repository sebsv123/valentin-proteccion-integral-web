...
const steps = [
  ...
  ['02', 'Revisamos', 'Revisamos modalidades, diferencias y condiciones relevantes.'],
  ['03', 'Decides tú', 'Te explicamos las opciones con claridad y tú eliges sin presión.'],
];

const trustRows = [
  { Icon: UsersRound, value: 'Seguimiento cercano', detail: 'acompañamiento durante el proceso' },
  { Icon: ShieldCheck, value: 'Orientación con experiencia', detail: 'condiciones claras antes y después de contratar' },
...
export function HealthFinalGuidanceSection({ whatsappMessage }: { whatsappMessage: string }) {
  ...
  const visibleSteps = en ? [['01', 'Tell us', 'Your situation, what you want to cover and how you plan to use the insurance.'], ['02', 'We review', 'We review relevant plans, differences and conditions.'], ['03', 'You decide', 'We explain the options clearly and you choose without pressure.']] : steps;
  const visibleTrustRows = en ? [{ Icon: UsersRound, value: 'Close follow-up', detail: 'support throughout the process' }, { Icon: ShieldCheck, value: 'Experienced guidance', detail: 'clear conditions before and after arranging cover' }, { Icon: Heart, value: 'No-obligation guidance', detail: 'clarity, care and professional judgement' }, { Icon: Phone, label: 'Would you rather talk?', value: '+34 603 448 765', detail: '', href: 'tel:+34603448765' }] : trustRows;
  return <section className={styles.section} aria-labelledby="salud-guidance-title">
    <div className={`container-shell ${styles.shell}`}><div className={styles.card}>
      <div className={styles.bluePanel}>
        ...
        <p className={styles.intro}>{en ? 'Tell us what you need, we review the options that may genuinely fit and you decide with all the information, without pressure.' : 'Nos cuentas qué necesitas, revisamos las opciones que realmente pueden encajar y tú decides con toda la información, sin presión.'}</p>
