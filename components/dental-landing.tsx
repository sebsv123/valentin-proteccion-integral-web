...
const DENTAL_WHATSAPP_URL = `https://wa.me/34603448765?text=${encodeURIComponent(DENTAL_WHATSAPP_MESSAGE)}`;
...
export function DentalLanding() {
  return (
    <>
      ...
      {/* 🚀 HERO SECTION - SIMPLIFICADO PARA SSR */}
      <section className="relative min-h-screen flex items-center justify-center border-b overflow-hidden py-20 pt-32 bg-background">
        {/* Background gradient for SSR */}
        <div className="absolute inset-0 bg-gradient-to-br from-emerald-50/50 via-background to-blue-50/30" />
      ...
      {/* 👨‍💼 SECCIÓN ASESORES - CON NUEVA FOTO DEL EQUIPO */}
        ...
        <div className="container max-w-6xl">
          <div className="grid lg:grid-cols-[5fr_7fr] gap-12 lg:gap-20 items-center">
            ...
            <div className="text-center lg:text-left">
              <h2 className="text-3xl font-bold tracking-tight sm:text-5xl mb-8">Somos Rosa y Sebastián</h2>
      ...
      <section className="py-14 sm:py-20 lg:py-24 bg-accent/30 border-y">
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-[1.2fr_1fr] gap-16 items-center">
            <div>
              <h2 className="text-3xl font-bold tracking-tight sm:text-5xl mb-12 text-center lg:text-left">Contrata tu seguro en 3 minutos. <br />En serio.</h2>
