          ...
          <div className="sm-panel-inner flex-1 flex flex-col gap-5 justify-center">
              ...
              {items && items.length ? (
                items.map((it, idx) => (
                  <li className="sm-panel-itemWrap relative overflow-hidden leading-none mb-4" key={it.label + idx}>
                    <Link
                      className="sm-panel-item relative text-[#002244] font-semibold text-[3rem] sm:text-[4rem] cursor-pointer leading-none tracking-[-2px] uppercase transition-[background,color] duration-150 ease-linear inline-block no-underline pr-[1.4em]"
                      href={it.link}
            ...
            {displaySocials && socialItems && socialItems.length > 0 && (
              <div className="sm-socials mt-auto pt-8 flex flex-col gap-3" aria-label="Social links">
                <h3 className="sm-socials-title m-0 text-base font-medium [color:var(--sm-accent,#0F5E9C)]">Contacto</h3>
                <ul
...
.sm-scope .staggered-menu-header { position: absolute; top: 0; left: 0; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 2.5em; background: transparent; pointer-events: none; z-index: 20; }
...
.sm-scope .sm-toggle-line { display: block; height: 1em; line-height: 1; text-transform: uppercase; font-weight: bold; }
...
.sm-scope .sm-socials-link:focus-visible { outline: 2px solid var(--sm-accent, #002244); outline-offset: 3px; }
...
.sm-scope .sm-socials-link:hover { color: var(--sm-accent, #002244); }
