        ...
        <div className="grid gap-8 xl:grid-cols-[1.35fr_1fr_1fr_1fr_1fr]">
          ...
          <div>
            ...
            <div className="mt-4 space-y-3 text-[var(--muted)]">
              ...
              <Link className="block hover:text-[var(--blue)]" href={linkHref('/autonomos')}>{isEnglish ? 'Self-employed solutions' : 'Soluciones para autónomos'}</Link>
            </div>
          </div>
          <div>
            ...
            <div className="mt-4 space-y-3 text-[var(--muted)]">
              ...
              <Link className="block tracking-wide hover:text-[var(--blue)]" href={linkHref('/empresas/salud')}>{isEnglish ? 'HEALTH FOR BUSINESSES & SELF-EMPLOYED' : 'SALUD PARA EMPRESAS Y AUTÓNOMOS'}</Link>
