      ...
      <p className="mt-2 leading-relaxed text-slate-700">{page.consulates[locale]}</p>
          ...
          <section className="mt-8 rounded-2xl bg-slate-50 p-5" aria-labelledby="vpi-interpretation">
            ...
            <p className="mt-2 leading-relaxed text-slate-700">{pageKey === 'tracker'
              ...
              : (en ? 'VPI is the commercial insurance mediation brand/project. We can help review available insurance arrangements; the insurer issues its own policy and certificate. Product terms and the competent authority’s assessment remain separate.' : 'VPI es la marca/proyecto comercial de mediación de seguros. Podemos ayudar a revisar las modalidades disponibles; cada aseguradora emite su propia póliza y certificado. Las condiciones del producto y la valoración de la autoridad competente son cuestiones distintas.')}</p>
          </section>
