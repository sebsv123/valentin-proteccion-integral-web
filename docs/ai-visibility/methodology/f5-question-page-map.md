...
| `/autonomos` | What real solutions can a self-employed professional review, and where should health intent go? | Audience triage toward unified business health or cybersecurity; tax treatment remains conditional and VPI is not a tax adviser. | `/empresas`, `/empresas/salud`, `/empresas/ciberseguridad` |
| `/empresas/salud` | How should a self-employed professional, team or SME review health insurance? | Profile, people, modality, minimum 2 for the specific ASISA PYMES family under review, tax scope and documentation. | `/empresas`, `/autonomos`, `/seguros/salud` |
