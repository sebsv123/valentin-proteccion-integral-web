...
| `/autonomos` | What can an autónomo insure? Can health premiums be deductible? What does VPI actually do? | Audience gateway to the unified branch. Tax treatment is conditional; distinguish health, accidents and other real products; VPI gives insurance guidance, not personal tax advice. | `/empresas/salud`, `/empresas`, `/contacto` |
| `/empresas` | What real solutions does VPI offer to businesses and self-employed professionals? | Unified commercial branch hub; show only the real health and cybersecurity routes. | `/empresas/salud`, `/empresas/ciberseguridad`, `/autonomos` |
| `/empresas/salud` | How many people can form a group? Is the minimum of two insured people relevant? Are outpatient, comprehensive and reimbursement options included? What information is needed? | Business/self-employed health decision page. Group composition and cover vary by modality; distinguish the solo individual-health path and keep tax treatment separate from coverage. | `/empresas`, `/autonomos`, `/seguros/salud` |
