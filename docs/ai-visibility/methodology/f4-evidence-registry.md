...
| ASISA Vida Tranquilidad: death from any cause, optional absolute permanent disability, annual renewal and international scope | Life editorial content | Product coverage/contract | ASISA 2026 product manual, Vida Tranquilidad section, pp. 3255–3339 | Strong primary insurer evidence | `VERIFIED` | ASISA manual, product section | Keep these facts tied to Vida Tranquilidad and its policy limits, ages and risk selection. |
| ASISA Vida Capital Decreciente: mortgage-oriented decreasing capital, death from any cause and optional absolute permanent disability | Mortgage-life editorial content | Product coverage | ASISA 2026 product manual, Vida Capital Decreciente / Vida Tranquilidad Hipoteca, pp. 3345–3411 | Strong primary insurer evidence | `VERIFIED` | ASISA manual, product section | Explain the mortgage/decreasing-capital purpose without implying that life insurance is legally mandatory or that every mortgage product has identical conditions. |
| ASISA Vida Accidentes Compromiso 10 and Accidentes Senior | Accident page/product copy | Product coverage/eligibility | ASISA 2026 product manual, Compromiso 10 and Senior sections, pp. 3417–3548 | Strong primary insurer evidence | `VERIFIED` | ASISA manual, product sections | Keep accident-only death/disability or senior fracture/hospitalisation guarantees separate from Vida Riesgo; ages, capitals and exclusions remain modality-specific. |
| Generic accident-page claims about no questionnaire, immediate cover, capital, hospitalisation or price | `/seguros/accidentes`, `/seguros/accidentes-decesos` | Product/price | Product manual supports some named modalities only; no universal VPI pack evidence | Primary product evidence is conditional | `NEEDS_REWORDING` | Accident landing metadata and cards | Corrected to modality-dependent wording; do not generalize Compromiso 10 or Senior conditions to every accident product. |
